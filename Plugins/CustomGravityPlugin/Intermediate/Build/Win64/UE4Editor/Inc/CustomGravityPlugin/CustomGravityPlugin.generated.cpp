...
static struct FScriptStruct_CustomGravityPlugin_StaticRegisterNativesFGravityInfo
{
	...
	IMPLEMENT_CLASS(UCustomGravityComponent, 2362812694);
...
static struct FScriptStruct_CustomGravityPlugin_StaticRegisterNativesFOrientationInfo
{
	...
	IMPLEMENT_CLASS(UCustomMovementComponent, 3124193431);
	...
	IMPLEMENT_CLASS(ACustomPawn, 1419578529);
	void AFirstPersonCharacter::StaticRegisterNativesAFirstPersonCharacter()
	{
	}
	IMPLEMENT_CLASS(AFirstPersonCharacter, 544612461);
	void AThirdPersonBall::StaticRegisterNativesAThirdPersonBall()
	{
	}
	IMPLEMENT_CLASS(AThirdPersonBall, 3789070305);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EMeshOrientation(EMeshOrientation_StaticEnum, TEXT("/Script/CustomGravityPlugin"), TEXT("EMeshOrientation"), false, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(AThirdPersonCharacter, 420814478);
	void ACustomPhysicsActor::StaticRegisterNativesACustomPhysicsActor()
	{
	}
	IMPLEMENT_CLASS(ACustomPhysicsActor, 2535470018);
	...
	IMPLEMENT_CLASS(APhysicsBallPawn, 1736458883);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ECollisionType(ECollisionType_StaticEnum, TEXT("/Script/CustomGravityPlugin"), TEXT("ECollisionType"), false, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(APlanetActor, 478385614);
...
// Cross Module References
	...
	UEnum* Z_Construct_UEnum_CustomGravityPlugin_EForceMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EForceMode::EFM_Acceleration")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EForceMode::EFM_Force")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EForceMode::EFM_MAX")), 2));
	...
	uint32 Get_Z_Construct_UEnum_CustomGravityPlugin_EForceMode_CRC() { return 76428802U; }
	UEnum* Z_Construct_UEnum_CustomGravityPlugin_EGravityType()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EGravityType::EGT_Default")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EGravityType::EGT_Point")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EGravityType::EGT_Custom")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EGravityType::EGT_GlobalCustom")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EGravityType::EGT_MAX")), 4));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_CustomGravityPlugin_EGravityType_CRC() { return 842987503U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UEnum* Z_Construct_UEnum_CustomGravityPlugin_ETraceShape()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ETraceShape::ETS_Sphere")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ETraceShape::ETS_Box")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ETraceShape::ETS_Line")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ETraceShape::ETS_MAX")), 3));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_CustomGravityPlugin_ETraceShape_CRC() { return 999579827U; }
	UEnum* Z_Construct_UEnum_CustomGravityPlugin_EVerticalOrientation()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EVerticalOrientation::EVO_GravityDirection")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EVerticalOrientation::EVO_SurfaceNormal")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EVerticalOrientation::EVO_MAX")), 2));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_CustomGravityPlugin_EVerticalOrientation_CRC() { return 4089100768U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UEnum* Z_Construct_UEnum_CustomGravityPlugin_EMeshOrientation()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EMeshOrientation::EMO_Movement")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EMeshOrientation::EMO_Camera")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EMeshOrientation::EMO_MAX")), 2));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_CustomGravityPlugin_EMeshOrientation_CRC() { return 4057643054U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UEnum* Z_Construct_UEnum_CustomGravityPlugin_ECollisionType()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ECollisionType::ECol_Mesh")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ECollisionType::ECol_Sphere")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("ECollisionType::ECol_MAX")), 2));
	...
	uint32 Get_Z_Construct_UEnum_CustomGravityPlugin_ECollisionType_CRC() { return 444416487U; }
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				...
				UProperty* NewProp_CollisionType = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("CollisionType"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(CollisionType, APlanetActor), 0x0010000000000005, Z_Construct_UEnum_CustomGravityPlugin_ECollisionType());
